...
>
> Add an "empty" line with just the `>` sign in it if you want to create a new paragraph within the blockquote.
...
For how many counties in Indiana is the black percentage higher than the overall black percentage in the state? How is it possible that the state percentage is so high given that so few counties are above it?
